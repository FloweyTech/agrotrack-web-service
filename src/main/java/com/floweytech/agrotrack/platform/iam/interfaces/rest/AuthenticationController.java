package com.floweytech.agrotrack.platform.iam.interfaces.rest;
...
import com.floweytech.agrotrack.platform.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.floweytech.agrotrack.platform.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.floweytech.agrotrack.platform.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
import com.floweytech.agrotrack.platform.iam.interfaces.rest.transform.UserResourceFromEntityAssembler;
...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthenticatedUserResource> signIn(@Valid @RequestBody SignInResource signInResource){
        ...
        var authenticatedUserResource = AuthenticatedUserResourceFromEntityAssembler.toResourceFromEntity(authenticatedUser.get().getLeft(),
