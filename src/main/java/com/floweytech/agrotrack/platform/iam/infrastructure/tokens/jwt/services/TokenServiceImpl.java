package com.floweytech.agrotrack.platform.iam.infrastructure.tokens.jwt.services;


import com.floweytech.agrotrack.platform.iam.infrastructure.authorization.sfs.model.UserDetailsImpl;
...
public class TokenServiceImpl implements BearerTokenService {
    ...
    private String buildTokenWithDefaultParameters(String username, String role, Long userId) {
        var issuedAt = new Date();
        var expiration = DateUtils.addDays(issuedAt, expirationDays);
        var key = getSigningKey();
        return Jwts.builder()
